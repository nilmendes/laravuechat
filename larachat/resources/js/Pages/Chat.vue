                    ...
                    <div class="w-9/12 flex flex-col justify-between">
                        ...
                        <div class="w-full p-6 flex flex-col overflow-y-scroll">
                            ...
                            >
                                ...
                                <span class="block my-1 text-xs text-gray-500"
                                >
                            ...
                            <form v-on:submit.prevent="sendMessage">
                                ...
                                >
                                    <input
                                        ...
                                        name
                                        id
                                        class="flex-1 px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-300 focus:border-transparent"
                                    />
                                    <button
                                        type="submit"
        ...
        sendMessage: async function(){
           await axios.post('api/messages/store', {
                ...
                this.messages.push({
                    ...
                    'to': this.userActive.id,
                    'content': this.message,
                    'created_at': new Date().formatDate,
                    'updated_at': new Date().formatDate,
                });
                this.message = '';
            });
